                ...
                <tr>
                    ...
                    <td>
                        @if ($booking->pembayaran)
                            @php
                            $pvClass = match($booking->pembayaran->status_verifikasi) {
                            ...
                            @endphp
                            <span class="badge {{ $pvClass }}">{{ ucfirst($booking->pembayaran->status_verifikasi) }}</span>
                            <div class="small text-muted mt-1">{{ $booking->pembayaran->metode_label }}</div>
                    ...
                    <td>
                        ...
                        @if (!$booking->pembayaran)
                        <a href="{{ route('user.qris.create', $booking) }}" class="btn btn-sm btn-navy">Pilih Pembayaran</a>
                        @endif
                        @if (!$booking->pembayaran || $booking->pembayaran->status_verifikasi === 'ditolak')
