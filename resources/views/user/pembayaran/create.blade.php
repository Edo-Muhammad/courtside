...
<div class="card shadow-sm" style="max-width: 500px;">
    <div class="card-body">
        ...
        <p class="mb-3"><strong>Total:</strong> Rp {{ number_format($booking->jadwal->totalHarga(), 0, ',', '.') }}
            <span class="text-muted small">({{ rtrim(rtrim(number_format($booking->jadwal->durasiJam(), 1), '0'), '.') }} jam &times; Rp {{ number_format($booking->jadwal->lapangan->harga_per_jam, 0, ',', '.') }}/jam)</span>
        </p>
