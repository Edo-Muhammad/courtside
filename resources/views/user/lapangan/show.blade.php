...
@section('back_url', route('user.lapangan.index'))
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span class="text-muted small d-block">({{ rtrim(rtrim(number_format($item->durasiJam(), 1), '0'), '.') }} jam)</span>
                    </td>
                    <td>
                        @if ($item->isBookable())
                ...
                @empty
                <tr>
                    <td colspan="5" class="text-center text-muted py-4">Belum ada jadwal tersedia untuk lapangan ini.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
