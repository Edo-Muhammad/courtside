...
<body>
    ...
    <div class="container mt-4">
        @auth
        @unless (request()->routeIs('admin.dashboard') || request()->routeIs('user.dashboard'))
        <a href="@yield('back_url', auth()->user()->isAdmin() ? route('admin.dashboard') : route('user.dashboard'))" class="btn btn-sm btn-outline-secondary mb-3">&larr; Kembali</a>
        @endunless
        @endauth
